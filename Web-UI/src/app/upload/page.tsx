...
const VIDEO_DETECT_URL = "/api/video_detect";
...
export default function UploadPage() {
  ...
  return (
    <AppShell
      ...
      subtitle="Tải video lên backend để chạy detect theo batch."
      right={
        <a
          ...
          <div className="rounded-3xl border bg-white p-5 shadow-sm space-y-4">
            <div>
              ...
              <div className="text-sm text-neutral-600">
                Backend sẽ sample frame theo stride để chạy detect và trả summary.
              </div>
            </div>
